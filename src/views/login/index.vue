<template>
  <div class="login">
    <div class="login-box">
      <img class="img1" src="@/assets/login/login-img.png" alt="" />
      <div class="login-form">
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules">
          <div class="login-form-title">
            <img src="@/assets/login/logo-new.png" style="width: 225px; height: 85px" alt="" />
            <!-- <span class="title-label">醒了么</span> -->
          </div>
...
.login {
  ...
  height: 100%;
  // background: #476dbe;
  // background-color: rgba(167, 243, 201, 0.5);
  // background-image: url('~@/assets/login/back-ground.png');
